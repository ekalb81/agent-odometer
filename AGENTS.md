...
Frontend unit and component tests use Vitest with jsdom and Svelte Testing Library; run them with `npm test`. Parser integration tests and fixtures live in `src-tauri/tests/`; small Rust unit tests live beside their modules.
